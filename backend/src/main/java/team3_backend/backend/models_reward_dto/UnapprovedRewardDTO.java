...
public class UnapprovedRewardDTO {
    ...
    public UnapprovedRewardDTO() {}

    public UnapprovedRewardDTO(Integer pointId, String username, LocalDateTime timestamp, Integer pointBalance) {
