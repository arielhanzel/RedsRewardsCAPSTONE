...
import team3_backend.backend.repository.RoleRepository;
...
public class AuthenticationService {
    ...
    public ApplicationUser registerUser(String username, String password, String email){
        ...
        return userRepository.save(new ApplicationUser(0, username, encodedPassword, authorities, email, null));
    }
